...
TRAINING_CHECKPOINTS=(
    ...
    "/checkpoint/agentic-models/winnieyangwn/SDPO/SDPO/checkpoints/FINAL-SDPO-mbs-8-train32-rollout8-lr1e-6-alpha1.0-drossTrue-seed456-modelQwen3-8B/global_step_50"
